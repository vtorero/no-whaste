    ...
    while ($row = $query->fetch_array()) {
        ...
        and v.fecha between '2022-05-01' and '2022-05-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query3->fetch_array()) {
            $mes3=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2022-06-01' and '2022-06-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query4->fetch_array()) {
            $mes4=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2022-07-01' and '2022-07-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query5->fetch_array()) {
            $mes5=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2022-08-01' and '2022-08-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query6->fetch_array()) {
            $mes6=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2022-09-01' and '2022-09-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query7->fetch_array()) {
            $mes7=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2022-10-01' and '2022-10-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query8->fetch_array()) {
            $mes8=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2022-11-01' and '2022-11-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query9->fetch_array()) {
            $mes9=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2022-12-01' and '2022-12-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query10->fetch_array()) {
            $mes10=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2023-1-01' and '2023-1-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query11->fetch_array()) {
            $mes11=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2023-2-01' and '2023-2-29' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query12->fetch_array()) {
            $mes12=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
        ...
        and v.fecha between '2023-3-01' and '2023-3-31' group by 1 order by 3 desc limit 1;");
           ...
           while ($row = $query13->fetch_array()) {
            $mes13=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
        }
/*productos*/
...
while ($row = $query->fetch_array()) {
        $prod1=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
    }
...
while ($row = $query->fetch_array()) {
        $prod2=array('id'=>(int) $row['id'],'nombre'=>$row['nombre']);
    }
...
while ($row = $query->fetch_array()) {
        $prod9=array('id'=>(int) $row['id'],'nombre'=>$row['nombre'],'imagen'=>"https://i.imgur.com/UVlQLGm.jpg");
    }
...
while ($row = $query->fetch_array()) {
            $prod10=array('id'=>(int) $row['id'],'nombre'=>$row['nombre'],'imagen'=>"https://i.imgur.com/UVlQLGm.jpg");
    }
...
while ($row = $query->fetch_array()) {
        $prod11=array('id'=>(int) $row['id'],'nombre'=>$row['nombre'],'imagen'=>"https://i.imgur.com/UVlQLGm.jpg");
    }
...
while ($row = $query->fetch_array()) {
        $prod12=array('id'=>(int) $row['id'],'nombre'=>$row['nombre'],'imagen'=>"https://i.imgur.com/UVlQLGm.jpg");
    }
...
while ($row = $query->fetch_array()) {
        $prod13=array('id'=>(int) $row['id'],'nombre'=>$row['nombre'],'imagen'=>"https://i.imgur.com/UVlQLGm.jpg");
    }

    $query=$db->query("SELECT case DATE_FORMAT(fecha,'%m')
    when 01 then 'Verano'
    when 02 then 'Verano'
    when 03 then 'Verano'
    when 04 then 'Otoño'
  ...
  DATE_FORMAT(fecha,'%y%m') mes,sum(valor_total) total FROM notas where fecha between '2023-01-01' and '2023-04-30' group by 1,2,3 order by 3 asc");
    ...
    while ($row = $query->fetch_array()) {
            $waste[]=(int) $row['total'];
            $season[]=array('cod_estacion'=>(int) $row['cod_estacion'],'estacion'=>$row['estacion'],'periodo'=>$row['mes']);
        }
        $query=$db->query("SELECT DATE_FORMAT(fecha,'%y%m') mes ,sum(valor_total) total FROM ventas where fecha between '2023-01-01' and '2023-04-30' group by 1 order by 1 asc");
        $sales=array();
     ...
     while ($row = $query->fetch_array()) {
      ...
      $query=$db->query("SELECT DATE_FORMAT(fecha,'%y%m') mes ,count(id) total FROM ventas where fecha between '2023-01-01' and '2023-04-30' group by 1 order by 1 asc;");
      $demand=array();
   ...
   while ($row = $query->fetch_array()) {
       ...
       $query=$db->query("SELECT DATE_FORMAT(v.fecha,'%y%m') fecha, count(vd.id_producto) total
       from ventas v, venta_detalle vd, productos pd,categorias cat,sub_categorias sc
       where v.id=vd.id_venta and vd.id_producto=pd.id and pd.id_categoria=cat.id and pd.id_subcategoria=sc.id
       and v.fecha between '2023-01-01' and '2023-04-31' group by 1 order by 1 asc;");
      $offers=array();
   ...
   while ($row = $query->fetch_array()) {
           $ventas_por_dia[]=array('fecha'=>$row['fecha'],'total'=>(int) $row['total']);
        ...
        $data = array("status"=>200,
        "categorias"=>array(array('id'=>1,'nombre'=>'charcuteria'),array('id'=>1,'nombre'=>'charcuteria'),array('id'=>1,'nombre'=>'charcuteria'),array('id'=>1,'nombre'=>'charcuteria')),
        "subCategorias"=>array($mes10,$mes11,$mes12,$mes13),
        "kilosFlag"=>array(0,1,1,1),
        "productos" =>array($prod10,$prod11,$prod12,$prod13),
        'waste'=>$waste,
        'demands'=>$demand,
        'offers'=>$offers,
        'season'=>$season,
